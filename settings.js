...
global.alivemsg = `📤Je suis actif maintenant😇
🤷‍♀️En quoi puis je t'aider?😉` //Costomize Alive Message (type your message in `` )
...
//owner v card
global.vcardowner = ['+22571615640'] // owner number
global.ownername = "winter" // owner name
global.ytname = "" // yt chanel name
global.socialm = "GitHub: winter094" // github or insta name
global.location = "Ivory Coast, Grandbassam, carrefour" // location
...
global.mess = {
    success: 'Terminé ✅',
    admin: 'seuls les Admins peuvent utiliser cette commande!😉',
    botAdmin: 'Je dois être Admin pour réaliser tes souhaits😥',
    owner: 'Seul mon Boss Winter a le pouvoir nécessaire pour utiliser cette commande !😉',
    ...
    nsfw: 'La commande pour Hentai est desactivée, contacte les Admins pour activer',
    banChat: 'The bot was banned in this group, please contact the owner to unban',
    badwords: '*Les Injures ne sont pas autorisées ici !*\n\n⚠️ Attention... ⚠️',
    spam: '⚠️ [SPAM] Detected ⚠️\n\nThe emergency security system was activated.\n\nPowered By: *ʀᴇᴅ-ᴅʀᴀɢᴏɴ*',
    caption: 'Generated by: ◉ *Winter-ᴅʀᴀɢᴏɴ-ʙᴏᴛ*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
